@echo off
REM Ocean View Resort - Frontend Start Script
REM This script runs the JavaFX desktop application

cd /d "%~dp0ocean-view-resort\desktop"
echo Starting Ocean View Resort Frontend...
echo.
